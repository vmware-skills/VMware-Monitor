...
PROPERTY_CHAINS = [
    ...
    ("alarm.AlarmState", "acknowledgedByUser"),
    ("alarm.AlarmState", "acknowledgedTime"),
    ("alarm.AlarmState", "alarm.info.expression"),
    ("alarm.StateAlarmExpression", "statePath"),
    ("alarm.StateAlarmExpression", "operator"),
    ("alarm.StateAlarmExpression", "red"),
    ("alarm.StateAlarmExpression", "yellow"),
    ("alarm.EventAlarmExpression", "eventTypeId"),
    ("alarm.AndAlarmExpression", "expression"),
    ("HostSystem", "runtime.connectionState"),
    # Events
