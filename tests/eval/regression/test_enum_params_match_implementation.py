...
from vmware_monitor.ops.health import SEVERITY_ORDER

# "unknown" is an output label for events neither vCenter nor this skill can
# rank; it is not something a caller filters *by*, so it is excluded here.
EXPECTED = [
    ("get_events", "severity", sorted(set(SEVERITY_ORDER) - {"unknown"})),
]
